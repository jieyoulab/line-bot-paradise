...
async function handle({ event, client }) {
  const videos = [
    { id: 'NHV136BYmFI', title: '【竹編成器 X 桂竹工作坊】', channel: '桂竹協會', desc: '冬耕春收，竹編工藝落地生根...', url: 'https://www.youtube.com/watch?v=NHV136BYmFI' },
    { id: 'rE42-6wLQAU', title: '【部落桂竹工坊 X 竹產業培力】', channel: '桂竹協會', desc: '從竹篾處理到竹編織的工藝課！謝玉環老師教學...', url: 'https://www.youtube.com/watch?v=rE42-6wLQAU' },
    { id: 'hrBoGRrVYN0', title: '櫓榪小舖農產介紹-栗子地瓜', channel: '桂竹協會', desc: '栗子地瓜是來自日本的品種...', url: 'https://www.youtube.com/watch?v=hrBoGRrVYN0' }
  ];
  ...
  const { quickReply } = buildQuickReplyPostback({
    ...
    items: [
      ...
      { label: '桂竹協會系列', data: 'action=yt_corporate__list' } // 當前
    ]
  });
